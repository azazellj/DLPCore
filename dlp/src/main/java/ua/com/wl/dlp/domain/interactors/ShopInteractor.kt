...
interface ShopInteractor : OffersInteractor {
    ...
    /**
     * Allows to delete all persisted shops from local DB.
     * @return If success, result is an instance of [Result.Success] with boolean flag inside, that indicates
     * whether entities were deleted successfully, otherwise [Result.Failure] with detailed [Throwable].
     */
     ...
     * otherwise [Result.Failure] with detailed [Throwable].
     */
    suspend fun incrementPersistedPreOrderCounter(shopId: Int, offerId: Int): Result<OfferEntity>
