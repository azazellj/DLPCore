...
class NewsFeedInteractorImpl(
    ...
    override suspend fun getCityNewsFeed(page: Int?, count: Int?): Result<PagedResponse<BaseNewsItemResponse>> =
    ...
    override suspend fun getShopNewsFeed(shopId: Int, page: Int?, count: Int?): Result<PagedResponse<BaseNewsItemResponse>> =
